...
class MADDPG():
    ...
    def __init__(self, state_size, action_size, num_agents, random_seed):
        ...
        for agent_num in range(num_agents):
            ...
            self.actor_optimizer.append(optim.Adam(self.actor_local[agent_num].parameters(), lr=LR_ACTOR))
    ...
    def step(self, states, actions, rewards, next_states, dones, timestep):
        ...
        if len(self.memory) > BATCH_SIZE:
            for agent_num in range(self.num_agents):
                ...
                if not experiences:
                    return
                self.learn(agent_num, experiences)
    ...
    def learn(self, agent_num, experiences, gamma=GAMMA):
        ...
        actions_next = self.actor_target[agent_num](next_states)
        ...
        # ---------------------------- update actor ---------------------------- #
        # Compute actor loss
        actions_pred = self.actor_local[agent_num](states)
